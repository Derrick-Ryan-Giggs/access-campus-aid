      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 py-3 border-2 border-gray-300 rounded-lg text-base bg-gray-50 text-gray-900 placeholder:text-gray-500 transition-all duration-200 ease-in-out focus:outline-none focus:ring-3 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white hover:border-gray-400 hover:bg-white"
          ...
          <select
            ...
            className="h-12 px-4 bg-gray-50 border-2 border-gray-300 text-gray-900 rounded-lg text-base focus:ring-3 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white hover:border-gray-400 hover:bg-white w-full sm:w-auto transition-all duration-200 ease-in-out"
