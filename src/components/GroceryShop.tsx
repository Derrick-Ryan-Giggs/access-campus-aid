...
const mockGroceries: GroceryItem[] = [
  ...
  { id: 7, name: "Greek Yogurt", category: "Dairy", price: 5.99, description: "Plain Greek yogurt, 32oz", image: "https://images.unsplash.com/photo-1571212515416-faf6018e6eed?w=400&h=300&fit=crop" },
  { id: 8, name: "Salmon Fillet", category: "Fish", price: 12.99, description: "Atlantic salmon, 1lb", image: "https://images.unsplash.com/photo-1590992427862-28bb1867e148?w=400&h=300&fit=crop" },
  ...
  { id: 15, name: "Quinoa", category: "Grains", price: 7.99, description: "Organic quinoa, 1lb", image: "https://images.unsplash.com/photo-1548095115-45ebe1f87996?w=400&h=300&fit=crop" },
